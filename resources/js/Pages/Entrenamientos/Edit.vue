...
const breadbrums = [
    ...
    },
    {
        ...
        disabled: false,
        url: route("entrenamientos.index"),
        name_url: "entrenamientos.index",
    },
    {
        title: "Nuevo",
        disabled: false,
...
const { oEntrenamiento, setEntrenamiento } = useEntrenamientos();
...
setEntrenamiento(props.entrenamiento, true);
