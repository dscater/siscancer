...
const breadbrums = [
    ...
    {
        title: "Reporte Historial de Pacientes",
        disabled: false,
        url: "",
        name_url: "",
    },
...
const listPacientes = ref([{ id: "TODOS", full_name: "TODOS" }]);

const generarReporte = () => {
    generando.value = true;
    const url = route("reportes.r_historial_pacientes", form.value);
...
onMounted(async () => {
    ...
    const nuevo_filtro = listPacientes.value.concat(pacientes);
    listPacientes.value = nuevo_filtro;
});
</script>
<template>
