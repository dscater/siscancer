...
const { oDoctor, limpiarDoctor } = useDoctors();
const accion = ref(props.accion_dialog);
const dialog = ref(props.open_dialog);
let form = useForm(oDoctor);
watch(
    () => props.open_dialog,
    (newValue) => {
        dialog.value = newValue;
        if (dialog.value) {
            form = useForm(oDoctor);
        }
    }
);
watch(
...
const tituloDialog = computed(() => {
    return accion.value == 0 ? `Agregar Doctor` : `Editar Doctor`;
});
                        ...
                        <form>
                            <v-row>
                                ...
                                <v-col cols="12" sm="6" md="4">
                                    <v-text-field
                                        :hide-details="
                                            form.errors?.especialidad ? false : true
                                        "
                                        :error="
                                            form.errors?.especialidad ? true : false
                                        "
                                        :error-messages="
                                ...
                                <v-col cols="12" sm="6" md="4">
                                    <v-text-field
                                        :hide-details="
                                            form.errors?.fono2 ? false : true
                                        "
                                        :error="
                                            form.errors?.fono2 ? true : false
                                        "
                                        :error-messages="
                                            form.errors?.fono2
                                                ? form.errors?.fono2
